...
def query_assays_endpoint(
    ...
    assay_target_fluorophore: str | None = Query(None),
    min_accepted_droplets: float | None = Query(None),
    max_accepted_droplets: float | None = Query(None),
    ...
    return query_assays(
        ...
        assay_target_fluorophore=assay_target_fluorophore,
        min_accepted_droplets=min_accepted_droplets,
        max_accepted_droplets=max_accepted_droplets,
