...
my %orderedcols = (
	"abatch"        => ["assay_batch_id", "assay_date", "assay_reaction_ul", "assay_machine", "assay_amplification_method", "assay_amplification_method_lot_id", "assay_quantification_method", "assay_quantification_type", "assay_batch_record_version", "assay_method", "assay_method_lot_id", "assay_analysis_software_version", "assay_run_by", "assay_batch_comment"],
