				...
				column(7,
					...
					fluidRow(
						...
						column(12,
							...
							plotlyOutput("cplot_covid", height="315", width="100%")
						)
			...
			fluidRow(
				...
				column(7,
					...
					fluidRow(
						...
						column(12,
							# Plot of abundance fold change and trend slopes
							plotlyOutput("cplot_flua", height="315", width="100%")
						)
					) # fluidRow (Change plot)
				)
			),
			...
			fluidRow(
				...
				column(7,
					...
					fluidRow(
						...
						column(12,
							# Plot of abundance fold change and trend slopes
							plotlyOutput("cplot_flub", height="315", width="100%")
						)
					) # fluidRow (Change plot)
				)
			),
			...
			fluidRow(
				...
				column(7,
					...
					fluidRow(
						...
						column(12,
							# Plot of abundance fold change and trend slopes
							plotlyOutput("cplot_rsv", height="315", width="100%")
						)
					) # fluidRow (Change plot)
				)
			),
