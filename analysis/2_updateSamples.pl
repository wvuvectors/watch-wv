...
########################
#
# This entire script needs to be written!
#
#
########################
...
$usage   .=  "Update the WaTCH-WV database with the update files from a compiled run.\n";
$usage   .=  "These files are generated by the 1_compileRun.pl script and found in the RUNDIR/updates folder.\n";
$usage   .=   "\n";
